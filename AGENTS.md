...
- `創作庫/Codex基本功EP09 - Supabase資料庫懶人包.md` — EP09 腳本（已發布）
- `創作庫/Codex基本功EP09.5 - Firebase串接免費資料庫.md` — EP09.5 腳本
- `創作庫/Codex基本功EP12 - 本地AI與免費API懶人包.md` — EP12 腳本（含 Groq + Vision）
- `Codex 懶人包/04-連接 Supabase 資料庫.md` — Supabase 懶人包 v0.4
- `Codex 懶人包/05-連接 Firebase 資料庫.md` — Firebase 懶人包 v0.7
...
| 老師管理 | Codex + MCP 直接查詢分析 | 完整權限 | 不需要（本機操作） |

### 關鍵決策
- **不使用 Google 登入**：對一般老師太複雜，改由 Codex + MCP 直接管理資料
...
> 完整場景對照、Firebase vs Supabase 決策辯論詳述 → 看創作庫 `Codex基本功EP09.5 - Firebase串接免費資料庫.md`
